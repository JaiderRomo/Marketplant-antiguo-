                ...
                <form action="{{ Route('blog.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        ...
                        <div>
                            <div class="grid grid-cols-1">
                                <label
                                    class="uppercase md:text-sm text-xs text-dark text-light font-semibold">Descripcion:</label>
                    ...
                    <div class="grid grid-cols-1 mt-5 mx-7">
                        <label class="uppercase md:text-sm text-xs text-dark text-light font-semibold mb-1">Subir
                            Imagen</label>
                        <div class='flex items-center justify-center w-full'>
                            <label
                                ...
                                <div class='flex flex-col items-center justify-center pt-7'>
                                    ...
                                    <p class='text-sm text-dark group-hover:text-purple-600 pt-1 tracking-wider'>Seleccione
                                        la imagen</p>
                                </div>
                    ...
                    <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                        ...
                        <button onclick="swal3()" type="submit"
